...
## [0.23.1](https://github.com/magrhino/WUD-Updater/compare/v0.42.5...v0.23.1) (2026-06-18)
...
* **container:** add WUD script startup sync ([718cbe2](https://github.com/magrhino/WUD-Updater/commit/718cbe29f1c7c394f030b33deb9f08a6921d11b5))
* **db:** Add SQLite persistence validation for the updater ([#20](https://github.com/magrhino/WUD-Updater/issues/20)) ([7a4c7d0](https://github.com/magrhino/WUD-Updater/commit/7a4c7d07e5d3a48f1b284d7119145a98586a5087))
...
* **docker:** add deployable updater image ([e9ccb99](https://github.com/magrhino/WUD-Updater/commit/e9ccb9928638bfa28a8709ec78633c41fd282340))
...
* **python:** add docker compose subprocess layer ([d75df3f](https://github.com/magrhino/WUD-Updater/commit/d75df3f9bd2d8f1268e60a5bee050e547e431fd1))
* **python:** add updater package skeleton ([028731c](https://github.com/magrhino/WUD-Updater/commit/028731c701a9e38932763c4d0d4630ae3f94fc17))
* **python:** Archive Bash updater and sync WUD scripts ([#11](https://github.com/magrhino/WUD-Updater/issues/11)) ([1277f94](https://github.com/magrhino/WUD-Updater/commit/1277f94a0fb0e01dd93301d1a1e0fbaedea8fcd0))
...
* scaffold wud updater ([5bbea9d](https://github.com/magrhino/WUD-Updater/commit/5bbea9d987b4d12e270c974394d56aba2cbfc8f9))
...
* **updater:** add opt-in compose tag updates ([d8f6ec8](https://github.com/magrhino/WUD-Updater/commit/d8f6ec885daf1470511f06616c0cfdd86f74291e))
* **updater:** add opt-in Python update-from-wud ([435da44](https://github.com/magrhino/WUD-Updater/commit/435da443ca4882a603b2a68c2234f62169ab4761))
...
* **updater:** make Python updater default ([be76a4e](https://github.com/magrhino/WUD-Updater/commit/be76a4ece7f791acd771bf64a41917bbec491ce8))
* **updates:** add interactive image selector ([b2511c8](https://github.com/magrhino/WUD-Updater/commit/b2511c8def0a3ba97df012a96c4d567dd47bd557))
* **updates:** add no-sudo Python wrapper mode ([689db28](https://github.com/magrhino/WUD-Updater/commit/689db2884ef18346f20de7cf3c57d24b166e2bdd))
* **updates:** add opt-in python wrapper parity ([a2e6746](https://github.com/magrhino/WUD-Updater/commit/a2e6746e1f9abef61456c150ffb36fa0ec94b8df))
* **updates:** add python updates wrapper ([f82817f](https://github.com/magrhino/WUD-Updater/commit/f82817f7ef0be15539ba050bf364c3d7b9977364))
...
* **wud-file:** add Python WUD lock cleanup helpers ([25148ac](https://github.com/magrhino/WUD-Updater/commit/25148ac0514c34a1d59b1ff1bacd8bc2d12ab20f))
* **wud:** add Python WUD parsing parity helpers ([c10f08f](https://github.com/magrhino/WUD-Updater/commit/c10f08fceecc23f3c107100bda5fc2463a534ae1))
...
* **ci:** install dev dependencies in workflow venv ([c6d9482](https://github.com/magrhino/WUD-Updater/commit/c6d94828612a6235f800c0352a4995cb9edead12))
* **command:** handle subprocess launch failures ([a85931e](https://github.com/magrhino/WUD-Updater/commit/a85931ec85e0379ce83a0953c8ded3d295360e4a))
* **compose:** align python docker layer with shell behavior ([14c07a4](https://github.com/magrhino/WUD-Updater/commit/14c07a4794b6c82766ffe26bc8a6430f350e32c3))
* **compose:** preserve recovery behavior in python layer ([5ab6bc4](https://github.com/magrhino/WUD-Updater/commit/5ab6bc4874e705d98dfb241ccc00d208c77f4474))
...
* **logs:** create generated logs exclusively ([51e63e7](https://github.com/magrhino/WUD-Updater/commit/51e63e78de8da460d60ebc079d30a213251d152b))
* **logs:** move default updater logs out of docker root ([dbf08e4](https://github.com/magrhino/WUD-Updater/commit/dbf08e42055eb019b8bafdfadbef057f2f33346d))
* **logs:** move default updater logs out of docker root ([00a7c4d](https://github.com/magrhino/WUD-Updater/commit/00a7c4d92d6b2f739666bee0b90cbdcc8677e75e))
...
* **python:** align config defaults and version floor ([9e0fb8b](https://github.com/magrhino/WUD-Updater/commit/9e0fb8b45ef5edf1dc5ebb7769dfac1369aa0a10))
...
* **updater:** preserve wud output ownership under sudo ([5b1b7d0](https://github.com/magrhino/WUD-Updater/commit/5b1b7d01c2625d323ebe3e1e608dfe5ecfa78a83))
...
* **updater:** restore WUD lines on tag backup failure ([98a1eac](https://github.com/magrhino/WUD-Updater/commit/98a1eac0d081e3f782e9fbac42708ab403be0544))
...
* **updates:** handle unreachable TrueNAS and interrupted prompts ([b6a80b1](https://github.com/magrhino/WUD-Updater/commit/b6a80b11c542a714225e28d19ff1f18ae4e349e8))
* **updates:** preserve python wrapper opt-in dispatch ([8a687b3](https://github.com/magrhino/WUD-Updater/commit/8a687b3dbfc2e6f810246b40fe7a4f22e8bbb35f))
...
* **updates:** validate WUD selections before updater handoff ([f434b56](https://github.com/magrhino/WUD-Updater/commit/f434b5676b9c5cfe42e7021d627b11254a7391cb))
* use home docker defaults and valid release payload ([66c8231](https://github.com/magrhino/WUD-Updater/commit/66c8231496c24dfd3519b62ad6497779312e44b5))
...
* **wud:** harden discord webhook payloads ([08dd624](https://github.com/magrhino/WUD-Updater/commit/08dd624f696351d567e37715485d6fdd5c9155ae))
* **wud:** preserve todo file shared access ([cb5b6fd](https://github.com/magrhino/WUD-Updater/commit/cb5b6fd8619bcb8804bdacf96c5cbd0d108408d0))
* **wud:** standardize release-note curl handling ([c81c928](https://github.com/magrhino/WUD-Updater/commit/c81c928d1bd5de03a2a2fecdcc5936eb9ebb961f))
* **wud:** stop generated digests from blocking updates ([148116f](https://github.com/magrhino/WUD-Updater/commit/148116f72901365326c07985f2277896f71acd54))
* **wud:** suppress trap-only cleanup shellcheck warning ([4afe941](https://github.com/magrhino/WUD-Updater/commit/4afe9416ceab920396c91ff85c891acea41346d0))
* **wud:** surface rewrite and semver failures ([77f2117](https://github.com/magrhino/WUD-Updater/commit/77f2117f0e5067b60785d0e482f15ab40bde22a6))
* **wud:** synchronize todo file rewrites ([1223e0b](https://github.com/magrhino/WUD-Updater/commit/1223e0b1c50fd4c59f2d98a7e493fc476b2f24b9))
...
* **agents:** tune context guidance ([c588d31](https://github.com/magrhino/WUD-Updater/commit/c588d31de3fb6be5ed972285bda317bf31aef11c))
* **changelog:** add Python updater default entry ([d870eb6](https://github.com/magrhino/WUD-Updater/commit/d870eb6e2cac8769dfa58b74cd7db5c1cc090afb))
* **changelog:** add updates wrapper entries ([23d0bc4](https://github.com/magrhino/WUD-Updater/commit/23d0bc48544a60eac60a8d2dee464ad49b649aee))
* **changelog:** note updater log directory change ([074b476](https://github.com/magrhino/WUD-Updater/commit/074b476b050b7ec4f4a7c46c450927424d331eaa))
* **docker:** add hardened socket proxy compose example ([3127d4f](https://github.com/magrhino/WUD-Updater/commit/3127d4f5190c189fa80b78fe4316d6130d4a3a90))
* **docker:** use published image in compose example ([fad3466](https://github.com/magrhino/WUD-Updater/commit/fad3466b562861aabff836aa4d352961a7bff6a2))
* document python refactor and changelog policy ([e665b57](https://github.com/magrhino/WUD-Updater/commit/e665b57cfa4d492d80d726e4067622c92f23da99))
...
* **github:** add contributor templates ([#15](https://github.com/magrhino/WUD-Updater/issues/15)) ([11f91d5](https://github.com/magrhino/WUD-Updater/commit/11f91d52f215d1ff0e6e6bf0f8aa20715f21e3c0))
...
* initialize repo guidance and README ([b120404](https://github.com/magrhino/WUD-Updater/commit/b1204043a6e178a9eee7e2c60152ab66e597bf87))
* Move temlpate.env and document ([f19a8ca](https://github.com/magrhino/WUD-Updater/commit/f19a8ca4f1601bdade2923ede1643d873fe870cf))
* **truenas:** align api client example with secret-file auth ([31e427e](https://github.com/magrhino/WUD-Updater/commit/31e427e13f8affbcac4d04c187573e37eb86f2f0))
