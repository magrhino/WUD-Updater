...
| WUD service-to-service trigger callbacks | `web_wud_triggers.py` | Keep POST-only, bearer-token protected, WUD API authoritative, and free of `images.todo` writes. Preserve release-notification settings gates, duplicate suppression, audit, and secret redaction. |
